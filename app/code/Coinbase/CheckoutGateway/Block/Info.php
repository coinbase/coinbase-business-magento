...
namespace Coinbase\CheckoutGateway\Block;
...
class Info extends ConfigurableInfo
{
    ...
    {
        $labels = [
            'coinbase_checkout_id' => __('Checkout ID'),
            'coinbase_checkout_url' => __('Checkout URL'),
            'coinbase_checkout_status' => __('Payment Status'),
            'coinbase_checkout_address' => __('Payment Address'),
