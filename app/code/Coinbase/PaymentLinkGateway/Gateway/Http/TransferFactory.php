...
namespace Coinbase\PaymentLinkGateway\Gateway\Http;

use Coinbase\PaymentLinkGateway\Gateway\Config;
use Coinbase\PaymentLinkGateway\Service\JwtGenerator;
...
{
    private const API_PATH = '/api/v1/payment-links';
    ...
    private function generateIdempotencyKey(string $orderId): string
    {
        ...
        $hash = md5('coinbase_payment_link_' . $orderId);
